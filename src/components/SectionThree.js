...
with learners, offering a wide range of solutions to enhance:
    ...
    <div className='mx-2 my-8'>
     ...
     <div className='flex justify-center'>
        <div className='w-52 h-16 rounded-lg border-2 border-slate-400 flex justify-center items-center'>
            Hobbies & Talents
        </div>
        </div> 
        ...
        <div className='w-28 h-16 rounded-lg border-2 border-slate-400 flex justify-center items-center'>
            Academics
        </div>
        <Image
        src={Group}
